...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('BACKUP_NAME', 'spatie-backup'),
        ...
        'source' => [
            'files' => [
                ...
                'include' => [
                    // base_path(),
                    storage_path('app/public'),     // This is where Storage::disk('public') saves files

                    // storage_path('app/public'),     // User uploads via Storage::disk('public')
                    // public_path('uploads'),         // Direct uploads to public/uploads
                    // public_path('images'),          // If you store images in public/images
                 ...
                 */
                'exclude' => [
                    // No need for excludes since we're only including specific dirs
                    // base_path('vendor'),
