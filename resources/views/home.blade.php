<x-app-layout title="Home Page">
    ...
    <div class="w-full mb-10">
        <div class="mb-16">
            <h2 class="mt-16 mb-5 text-3xl font-bold text-yellow-500 bg-white">{{ __('home.featured_posts') }}</h2>
            <div class="w-full">
            ...
            <a class="block mt-10 text-lg font-semibold text-center text-yellow-500 bg-white" href="{{ route('posts.index') }}">{{ __('home.more_posts') }}</a>
        </div>
        <hr>

        <h2 class="mt-16 mb-5 text-3xl font-bold text-yellow-500 bg-white">{{ __('home.latest_posts') }}</h2>
