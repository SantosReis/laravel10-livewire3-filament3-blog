<x-app-layout title="Home Page">
    @section('hero')
        <div class="w-full py-32 text-center">
            ...
            <a class="inline-block px-3 py-2 mt-5 text-lg text-white bg-gray-800 rounded" href="{{ route('posts.index') }}">{{ __('home.hero.cta') }}</a>
        </div>
    @endsection
    ...
    <div class="w-full mb-10">
        <div class="mb-16">
            ...
            <a class="block mt-10 text-lg font-semibold text-center text-yellow-500" href="{{ route('posts.index') }}">{{ __('home.more_posts') }}</a>
        </div>
        <hr>
